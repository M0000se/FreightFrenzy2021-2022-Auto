...
public class Constants
{
    ...
    public static double dist_multiplier= 3.0;


    //Red-specific auto variables
    public static double red_basic_shipHubDelay = 0.1; // constant minimal time to complete a corresponding marker ITS ABOUT MARKERS
    ...
    public static int liftLow  = -2400; //encoder value for the low ship hub position of the lift
    ...
    public static int p_error = 50; // max allowed lift position error
    public static double p = 0.001;

    //Dump variables (Dump is arm)
    public static double dumpStraight = 0.78; //position value for the Intake position of the dump (straight angle)
    public static double dumpLow = 0.78;
