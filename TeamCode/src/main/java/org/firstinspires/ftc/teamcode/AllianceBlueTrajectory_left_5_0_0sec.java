...
@Autonomous (name = "AUTO BLUE 5 0 0 sec")//STARTUP TIME, AFTER WE DROP THE BLOCK TIME, AND SPINNER POINT DELAY
public class AllianceBlueTrajectory_left_5_0_0sec extends LinearOpMode //spaghetti code incoming sry
{
