...
@Autonomous (name = "AUTO BLUE 0 5 0 sec")//STARTUP TIME, AFTER WE DROP THE BLOCK TIME, AND SPINNER POINT DELAY
public class AllianceBlueTrajectory_left_0_5_0sec extends LinearOpMode //spaghetti code incoming sry
{
