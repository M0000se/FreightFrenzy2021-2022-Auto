...
@Autonomous (name = "AUTO RED 0 0 0 sec (default)")
public class AllianceRedTrajectory_left extends LinearOpMode //spaghetti code incoming sry
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Vector2d storage = new Vector2d(110, -80);
        Vector2d end = new Vector2d(110, -51);
