...
@Autonomous (name = "AUTO BLUE 0 0 5 sec")//STARTUP TIME, AFTER WE DROP THE BLOCK TIME, AND SPINNER POINT DELAY
public class AllianceBlueTrajectory_left_0_0_5sec extends LinearOpMode //spaghetti code incoming sry
{
