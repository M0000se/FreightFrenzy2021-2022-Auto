...
@Disabled
@Autonomous (name = "AUTO RED barrier")
public class AllianceRedTrajectory_barrier extends LinearOpMode //spaghetti code incoming sry
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d storageMidpoint = new Pose2d(0, -65, Math.toRadians(0));
        Vector2d storage = new Vector2d(140, -65);
        ...
        TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                                ...
                                .addTemporalMarker(1, () -> {Claw.setPosition(0.5);}) //servo dump
                                .waitSeconds(1)
