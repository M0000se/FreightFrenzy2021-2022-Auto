...
Hardware:	This is not an actual OpMode, but a helper class that is used to describe
            ...
            Teams can copy one of these to create their own sampleMecanumDrive definition.
...
Special programming methods, or sampleMecanumDrive control techniques should be reserved for “Concept” Samples,
